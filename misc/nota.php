...
$pdf->Cell(60,10,'SISTEMA|',0,1,'C');

$pdf->Line(10,18,72,18);
$pdf->Line(10,19,72,19);

$pdf->SetFont('Arial','',8);
$pdf->Cell(60,3,'Direccion: Chichicastenago, Quiche, Guatemala',0,1,'C');

$pdf->SetFont('Arial','',8);
$pdf->Cell(63,3,'Muchas Gracias Por Su Compra',0,1,'C');

$pdf->SetFont('Arial','',8);
$pdf->Cell(63,4,'Telefono: 4804-4436',0,1,'C');
...
$pdf->Cell(60,6 ,'Comprobante de Compra',0,1,'C');
