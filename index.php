...
<div class="login-box">
  <div class="login-logo">
    <a href="https://www.configuroweb.com/contacto/"><b>MULTICENTER|</b>INTERFAST</a>
  </div>
  <!-- /.login-logo -->
      ...
      <?php
        if(!empty($message)){
          echo'<script type="text/javascript">
              ...
              swal("Login Success", "BIENVENIDO '.$_SESSION['role'].'", "success", {
              button: "Continuar",
                });
              });
              </script>';
        ...
        if(empty($errormsg)){
          ...
          echo'<script type="text/javascript">
              jQuery(function validation(){
              swal("Login Failed", "Usuario y Contraseña Incorrecto!", "error", {
              button: "Continuar",
                });
              });
          </script>';
